...
--    2 : preview
SERVER_CONFIG = 0
SERVER_CONFIG_ONLINE_URL = "http://api.miwifi.com"
...
FORK_RESTART_WIFI = "sleep 4; /sbin/wifi >/dev/null 2>/dev/null"
FORK_RESTART_WIFI_SHARE = "sleep 4; /sbin/wifi >/dev/null 2>/dev/null; /usr/sbin/shareUpdate -b >/dev/null 2>/dev/null"
...
CROM_DISK_CACHE_FILEPATH = "/userdisk/customrom.bin"
...
XQ_VERIFY_IMAGE = "cd /tmp;mkxqimage -v "
XQ_VERIFY_IMAGE_R1D = "cd /tmp;mkxqimage -x "

OPEN_WPS = "wps pbc"
GET_WPS_STATUS = "nvram show | grep wps_proc_status"
GET_WPS_CONMAC = "nvram get wps_sta_mac"
...
-- QoS
QOS_APPSL_ENABLE = "/etc/init.d/app-tc.d enable ; /etc/init.d/app-tc.d start"
QOS_APPSL_DISABLE = "/etc/init.d/app-tc.d stop ; /etc/init.d/app-tc.d disable"
QOS_APPSL_RELOAD = "/etc/init.d/app-tc.d reload"
...
DISK_CHECK_PATH = "/tmp/no_hdd_disk"