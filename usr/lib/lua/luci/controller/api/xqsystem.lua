...
function index()
    ...
    entry({"api", "xqsystem", "fac_info"}, call("getFacInfo"), (""), 101,true)
    ...
    entry({"api", "xqsystem", "sdev"}, call("specialDevCount"), (""), 180)
    -- Privacy
    entry({"api", "xqsystem", "privacy"}, call("privacy"), (""), 182)
    entry({"api", "xqsystem", "set_privacy"}, call("setPrivacy"), (""), 183)
    -- Country Code
    entry({"api", "xqsystem", "country_code"}, call("getCountryCode"), (""), 184)
    entry({"api", "xqsystem", "set_country_code"}, call("setCountryCode"), (""), 185)
    -- Push
    entry({"api", "xqsystem", "push_settings"}, call("getPushSettings"), (""), 187)
    entry({"api", "xqsystem", "push_switch"}, call("pushSwitch"), (""), 188)
    entry({"api", "xqsystem", "dev_notify"}, call("setDevNotify"), (""), 189)
    -- OTA Auto
    entry({"api", "xqsystem", "ota"}, call("getOTAInfo"), (""), 190)
    entry({"api", "xqsystem", "set_ota"}, call("setOTAInfo"), (""), 191)
    -- For messagingagent
    entry({"api", "xqsystem", "devicelist"}, call("devicelistForMAgent"), (""), 193)
end
...
function getInitInfo()
    ...
    result["language"] = XQCountryCode.getCurrentJLan()
...
function upgradeRom()
    ...
    if needpermission and needpermission == 0 then
...
function mainStatusForApp()
    ...
    result["lanip"] = LuciNetwork:get_network("lan"):ipaddr() or ""
    -- userdisk
