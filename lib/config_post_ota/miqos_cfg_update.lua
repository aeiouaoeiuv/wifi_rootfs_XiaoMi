...
function main()
    ...
    merge_tbl(curs,from_cfg,to_cfg,'system','param',true)
    merge_tbl(curs,from_cfg,to_cfg,'limit','guest',nil)
    merge_tbl(curs,from_cfg,to_cfg,'group','00',nil)
    merge_tbl(curs,from_cfg,to_cfg,'mode','general',nil)
    ...
    merge_tbl(curs,from_cfg,to_cfg,'class','p5',true)
